...
writer = SummaryWriter('NonAtari/DoubleDuelingDeepQNetwork/Cartpole')
...
class TestEnv:
    def __init__(self, name: str):
        ...
        self.env = gym.wrappers.RecordVideo(
            self.env, video_folder='NonAtari/DoubleDuelingDeepQNetwork/Cartpole', episode_trigger=lambda x: True)
