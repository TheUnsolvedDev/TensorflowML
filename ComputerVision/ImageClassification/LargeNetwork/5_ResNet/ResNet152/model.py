...
def resnet152_model(input_shape=(INPUT_SIZE[0], INPUT_SIZE[1], 3), num_classes=10):
    ...
    # ResNet-152 block config: [3, 8, 36, 3]
    x = make_layer(x, 64, 3, stride=1, name='layer1')
    x = make_layer(x, 128, 8, stride=2, name='layer2')
    x = make_layer(x, 256, 36, stride=2, name='layer3')
