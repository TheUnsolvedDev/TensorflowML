...
callbacks = [
    ...
    tf.keras.callbacks.ModelCheckpoint(
        filepath='model_NIN_net.h5', save_weights_only=True, monitor='val_loss', save_best_only=True),
...
def NiN(input_shape, num_classes):
    ...
    x = NiN_block(inputs, filters=192, kernel_size=5,
...
if __name__ == '__main__':
    model = NiN(input_shape=(64, 64, 3), num_classes=10)
    model.summary()
    tf.keras.utils.plot_model(model, to_file=NiN.__name__+'.png')
