...
def densenet_model_264(input_shape=(INPUT_SIZE[0], INPUT_SIZE[1], INPUT_SIZE[2]), num_classes=10, K=64, theta=0.5, num_blocks=[6, 12, 32, 48], dropout_rate=0.4, weight_decay=1e-4):
