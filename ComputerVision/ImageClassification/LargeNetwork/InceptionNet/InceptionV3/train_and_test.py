...
def main():
    ...
    callbacks = [
        ...
        tf.keras.callbacks.ModelCheckpoint(
            filepath='model_inception3_' + args.type + '.weights.h5', save_weights_only=True, monitor='val_loss', save_best_only=True),
    ...
    with strategy.scope():
        model = inception3_model(input_shape=(
    ...
    tf.keras.utils.plot_model(
        model, to_file=inception3_model.__name__+'.png')
