...
def main():
    ...
    callbacks = [
        ...
        tf.keras.callbacks.ModelCheckpoint(
            filepath='model_inception2_' + args.type + '.weights.h5', save_weights_only=True, monitor='val_loss', save_best_only=True),
    ...
    with strategy.scope():
        model = inception2_model(input_shape=(
    ...
    tf.keras.utils.plot_model(
        model, to_file=inception2_model.__name__+'.png')
