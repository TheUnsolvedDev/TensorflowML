...
def main():
    ...
    gen_optimizer = tf.keras.optimizers.Adam(learning_rate=GENERATOR_LEARNING_RATE, beta_1=0.5)
    disc_optimizer = tf.keras.optimizers.Adam(learning_rate=DISCRIMINATOR_LEARNING_RATE, beta_1=0.5)
